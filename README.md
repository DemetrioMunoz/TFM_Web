...
- 'web_test': Archivo Jupyter Notebook que contiene la implementacion del modelo K-means y las diferentes técnicas de preprocesamiento. Además de obtener guardar los modelo en los archivos pickle.
...
- **Aplicación web interactiva**: https://tfm-web.onrender.com/ (**Aceder a la aplicación web por primera vez puede demorar unos minutos**)
## Autor
-  **Nombre**: Demetrio Muñoz Álvarez
